...
<                   move to the end of the actual string
[<]                 move to the original 0
>                   move to right one
#                   read the filename starting from the current cell
>                   move over another to the right
![> !]              read the entire file
<                   shift left to the end of the file contents
[<]                 go to right before the start of the file contents
>                   go to the file contents
[.>]                print file contents